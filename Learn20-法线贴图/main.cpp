...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (isRotation)
			rotaion += deltaTime;
		model = glm::rotate(model, rotaion, glm::normalize(glm::vec3(1.0, 0.0, 1.0))); // Rotates the quad to show normal mapping works in all directions
...
void Do_Movement()
{
	...
	isRotation = keys[GLFW_KEY_SPACE];
}
